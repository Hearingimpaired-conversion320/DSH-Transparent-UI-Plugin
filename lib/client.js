	...
	factory: (require) => {
		...
		*/
		...
		var AquaAppearanceRow_module_css_default = {
			...
			"group": "VYJBRq_group",
			"disabledHint": "VYJBRq_disabledHint",
			"knob": "VYJBRq_knob",
		...
		*/
		function AquaAppearanceRow(props) {
			const { t, setMode, setBlur, setFrost, setFluidHue, setBgBrightness, setBackground, setWallpaper, setWallpaperBlur, setWallpaperFrost, useStore } = props;
			const enabled = useStore((s) => s.enabled);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: AquaAppearanceRow_module_css_default.title,
						children: t("aqua.title")
					}),
					!enabled && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: AquaAppearanceRow_module_css_default.disabledHint,
						children: t("aqua.disabledHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: enabled ? AquaAppearanceRow_module_css_default.controls : `${AquaAppearanceRow_module_css_default.controls} ${AquaAppearanceRow_module_css_default.dim}`,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
