window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var AquaPluginCard_module_css_default = {
			...
			"modeRow": "EG3s1W_modeRow",
			"modeHint": "EG3s1W_modeHint",
			"segActive": "EG3s1W_segActive",
			"modeLabel": "EG3s1W_modeLabel",
		...
		function AquaPluginCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: AquaPluginCard_module_css_default.modeRow,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: AquaPluginCard_module_css_default.modeLabel,
							children: t("aqua.mode")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: AquaPluginCard_module_css_default.segmented,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: mode === "float" ? AquaPluginCard_module_css_default.segActive : AquaPluginCard_module_css_default.seg,
								"aria-pressed": mode === "float",
								onClick: () => {
									setMode("float");
								},
								children: t("aqua.modeFloat")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: mode === "compat" ? AquaPluginCard_module_css_default.segActive : AquaPluginCard_module_css_default.seg,
								"aria-pressed": mode === "compat",
								onClick: () => {
									setMode("compat");
								},
								children: t("aqua.modeCompat")
							})]
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: AquaPluginCard_module_css_default.modeHint,
						children: t("aqua.modeHint")
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: AquaPluginCard_module_css_default.controls,
						children: [
							mode === "float" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Knob, {
								label: t("aqua.blur"),
								value: blur,
								min: 0,
								max: 40,
		...
		*/
		var AquaLayer = class {
			...
			*/
			...
			applyTokens() {
				this.tokenDisposer?.();
				this.tokenDisposer = this.ctx.theme.overrideTokens(OVERRIDE_SOURCE, this.settings.mode === "float" ? AQUA_TOKEN_OVERRIDES : COMPAT_TOKEN_OVERRIDES);
			}
			mount() {
